...
<template>
  <div
    class="login-container relative size-full flex min-h-full overflow-hidden"
  >
    <!-- logo -->
    <div
      class="absolute left-0 top-0 h-15 pl-12px z-9 flex-y-center justify-between"
    >
    ...
    <!-- 左侧登录 -->
    <div
      class="login-container-left login-bg relative hidden inset-0 flex-1 lg:block"
    >
      <div class="h-full flex flex-col items-center justify-center -enter-x">
        <img
          src="@/assets/imgs/login-img.png"
          alt="login-img"
    ...
    >
      <div class="relative flex justify-center w-full">
        <div
          class="w-full px-50px px-24px lt-sm:w-350px lt-lg:w-500px lt-sm:px-24px lt-sm:px-12px 2xl:w-600px"
        >
      ...
      <div
        class="flex-y-center position-absolute right-0 top-0 h-15 pr-12px z-9"
      >
        <ThemeSchemaSwitch

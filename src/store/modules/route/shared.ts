...
import type { LastLevelRouteKey, PageConstRoute, RouteKey, RouteMap } from '@page-router/types';
 ...
 * @param roles Roles
 */
export function filterAuthRoutesByRoles(routes: PageConstRoute[], roles: string[]) {
 ...
 * @param roles Roles
 */
function filterAuthRouteByRoles(route: PageConstRoute, roles: string[]): PageConstRoute[] {
 ...
 * @param routes Auth routes
 */
export function filterRoutesByDev(routes: PageConstRoute[]) {
 ...
 * @param route Auth route
 */
function filterRouteByDev(route: PageConstRoute): PageConstRoute[] {
 ...
 * @param route route
 */
function sortRouteByOrder(route: PageConstRoute) {
 ...
 * @param routes routes
 */
export function sortRoutesByOrder(routes: PageConstRoute[]) {
 ...
 * @param routes Auth routes
 */
export function getGlobalMenusByAuthRoutes(routes: PageConstRoute[]) {
 ...
 * @param route
 */
function getGlobalMenuByBaseRoute(route: RouteLocationNormalizedLoaded | PageConstRoute) {
 ...
 * @param routes
 */
export function isRouteExistByRouteName(routeName: RouteKey, routes: PageConstRoute[]) {
 ...
 * @param routeName
 */
function recursiveGetIsRouteExistByRouteName(route: PageConstRoute, routeName: RouteKey) {

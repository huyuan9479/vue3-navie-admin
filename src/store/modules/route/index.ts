...
import { RootRoute } from '@/router/routes/constant';
import { getRouteName, getRoutePath } from '@/router/route-map';
...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  async function initDynamicAuthRoute() {
    ...
    if (!error) {
      ...
      addAuthRoutes(routes as unknown as RouteRecordRaw[]);
  ...
  function handleConstantAndAuthRoutes() {
    const allRoutes = filterRoutesByDev([
  ...
  function handleUpdateRootRouteRedirect(redirectKey: LastLevelRouteKey) {
    ...
    if (redirect) {
      const rootRoute = { ...RootRoute, redirect } as RouteRecordRaw;

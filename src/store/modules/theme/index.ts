...
export const useThemeStore = defineStore(SetupStoreId.Theme, () => {
  ...
  const naiveThemeOverrides: Ref<App.Theme.NaiveUIThemeOverride | undefined> =
    ref(undefined);
  ...
  scope.run(() => {
    ...
    watch(
      () => [
        settings.value.watermark.visible,
        settings.value.watermark.enableTime,
      ],
      () => {

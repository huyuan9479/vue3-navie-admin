...
declare module "@page-router/types" {
  type PageConstRoute = Omit<import('vue-router')._RouteRecordBase, "name" | "path" | "children"> & {
    name: string;
    path: string;
    component?: string;
  ...
  */
   ...
   * the elegant route
   */
  type PageRoute = GeneratedRoute | CustomRoute;
}

  ...
  >
    ...
    >
      <SettingItem
        ...
        key="1"
        :label="$t('theme.layout.sider.width')"
      >
        <NInputNumber
      ...
      <SettingItem
        v-if="layoutMode === 'vertical'"
        key="2"
        :label="$t('theme.layout.sider.collapsedWidth')"
      >
        <NInputNumber
      ...
      <SettingItem
        ...
        key="3"
        :label="$t('theme.layout.sider.mixWidth')"
      >
        <NInputNumber
      ...
      <SettingItem
        v-if="isMixLayoutMode"
        key="4"
        :label="$t('theme.layout.sider.mixCollapsedWidth')"
      >
        <NInputNumber
      ...
      <SettingItem
        ...
        key="5"
        :label="$t('theme.layout.sider.mixChildMenuWidth')"
      >
        <NInputNumber
      ...
      <SettingItem
        v-if="isHybridLayoutMode"
        key="6"
        :label="$t('theme.layout.sider.autoSelectFirstMenu')"
      >
        <template #suffix>
          <IconTooltip
            :desc="$t('theme.layout.sider.autoSelectFirstMenuTip')"
          />
        </template>

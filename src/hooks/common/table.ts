...
export type UseNaiveTableOptions<
  ResponseData,
  ApiData,
...
type UseNaivePaginatedTableOptions<ResponseData, ApiData> =
...
export function useNaivePaginatedTable<ResponseData, ApiData>(
  ...
  const mobilePagination = computed(() => {
    const p: PaginationProps = {
      ...
      prefix:
        !isMobile.value && showTotal.value ? pagination.prefix : undefined,
    };
